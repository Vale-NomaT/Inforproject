...
@section('content')
        <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center md:justify-between">
            <div class="grow">
                <h5 class="text-16">Edit Child Details</h5>
            </div>
        ...
        <div class="card">
            <div class="card-body max-h-[70vh] overflow-y-auto [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-track]:bg-slate-100 [&::-webkit-scrollbar-thumb]:bg-slate-300 dark:[&::-webkit-scrollbar-track]:bg-zink-700 dark:[&::-webkit-scrollbar-thumb]:bg-zink-500">
                <form method="POST" action="{{ route('parent.children.update', $child->id) }}" class="space-y-4">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-4">
                        ...
                        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            <div>
                                ...
                                <input type="text" id="first_name" name="first_name" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" placeholder="First Name" value="{{ old('first_name', $child->first_name) }}" required>
                                @error('first_name')
                            ...
                            <div>
                                ...
                                <input type="text" id="last_name" name="last_name" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" placeholder="Last Name" value="{{ old('last_name', $child->last_name) }}" required>
                                @error('last_name')
                                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="grid grid-cols-1 gap-4 mt-4 sm:grid-cols-2">
                            <div>
                                ...
                                <input type="date" id="date_of_birth" name="date_of_birth" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" value="{{ old('date_of_birth', $child->date_of_birth) }}" required>
                                @error('date_of_birth')
                                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <select id="relationship" name="relationship" class="form-select border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" required>
                                    ...
                                    <option value="Mother" {{ old('relationship', $child->relationship) == 'Mother' ? 'selected' : '' }}>Mother</option>
                                    <option value="Father" {{ old('relationship', $child->relationship) == 'Father' ? 'selected' : '' }}>Father</option>
                                    <option value="Guardian" {{ old('relationship', $child->relationship) == 'Guardian' ? 'selected' : '' }}>Guardian</option>
                                    <option value="Grandparent" {{ old('relationship', $child->relationship) == 'Grandparent' ? 'selected' : '' }}>Grandparent</option>
                                    <option value="Other" {{ old('relationship', $child->relationship) == 'Other' ? 'selected' : '' }}>Other</option>
                                </select>
                                @error('relationship')
                                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                                @enderror
                    ...
                    <div class="mb-4 border-t border-slate-200 pt-4 dark:border-zink-500">
                            ...
                            <div>
                                ...
                                <select id="school_id" name="school_id" class="form-select border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" required>
                                    ...
                                    @foreach($schools as $school)
                                        <option value="{{ $school->id }}" {{ old('school_id', $child->school_id) == $school->id ? 'selected' : '' }}>{{ $school->name }}</option>
                                    @endforeach
                                </select>
                                @error('school_id')
                                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                            ...
                            <div>
                                ...
                                <select id="grade" name="grade" class="form-select border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200">
                                    ...
                                    @foreach(['ECD A', 'ECD B', 'Grade 1', 'Grade 2', 'Grade 3', 'Grade 4', 'Grade 5', 'Grade 6', 'Grade 7'] as $grade)
                                        <option value="{{ $grade }}" {{ old('grade', $child->grade) == $grade ? 'selected' : '' }}>{{ $grade }}</option>
                                    @endforeach
                                </select>
                                @error('grade')
                                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                            ...
                            <div class="p-4 bg-slate-50 rounded-lg border border-slate-200 dark:bg-zink-700 dark:border-zink-500">
                                ...
                                <div class="space-y-3">
                                    ...
                                    <div class="flex items-center gap-2">
                                        <button type="button" onclick="useCurrentLocation()" class="px-3 py-1.5 text-sm text-blue-600 bg-blue-100 rounded hover:bg-blue-200 transition-colors flex items-center gap-1">
                        ...
                        <div class="grid grid-cols-1 gap-4 mt-4 sm:grid-cols-2">
                            <div>
                                ...
                                <input type="time" id="school_start_time" name="school_start_time" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" value="{{ old('school_start_time', \Carbon\Carbon::parse($child->school_start_time)->format('H:i')) }}" required>
                            ...
                            <div>
                                ...
                                <input type="time" id="school_end_time" name="school_end_time" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" value="{{ old('school_end_time', \Carbon\Carbon::parse($child->school_end_time)->format('H:i')) }}" required>
                    ...
                    <div class="mb-4 border-t border-slate-200 pt-4 dark:border-zink-500">
                        ...
                        <div>
                            ...
                            <textarea id="medical_notes" name="medical_notes" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" rows="3">{{ old('medical_notes', $child->medical_notes) }}</textarea>
                            @error('medical_notes')
                                <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                            @enderror
                        </div>
